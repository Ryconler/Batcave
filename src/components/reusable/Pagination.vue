<template>
  <div class="pagination">
    <ul class="pagination">
      <li :class="{disabled: curPage===1||pages.length===1}"><a href="javascript: void(0);"
                                                                @click="pageMinus">&laquo;</a></li>
      <li v-for="page of pages" :class="{active: page===curPage||pages.length===1}" @click="pageTo(page)">
        <a href="javascript: void(0);">{{page}}</a>
      </li>

      <!--<li class="disabled"><a href="javascript: void(0);">&hellip;</a></li>-->

      <li :class="{disabled: curPage===pages.length||pages.length===1}">
