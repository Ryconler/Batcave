export default {
  selectNone(state) {
    ...
    state.myLikeSelect = false
    state.myURLSelect = false
    state.myFileSelect = false
    state.changePswSelect = false
    state.login = false
